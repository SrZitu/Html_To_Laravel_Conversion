...
<head>
    ...
    <!-- fevicon -->
    <link rel="icon" href="{{url('frontend/icon/fevicon.png')}}" type="image/gif" />
    ...
    <link rel="stylesheet" href="{{url('frontend/https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.css')}}"
        media="screen">
    <!--[if lt IE 9]>
